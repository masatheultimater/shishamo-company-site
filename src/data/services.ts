...
export const serviceData: Record<string, ServiceDetailData> = {
  ...
  'web-development': createServiceData({
    ...
    features: [
      { icon: 'ri:computer-line', title: '幅広い開発経験', description: '12年のWeb開発経験を活かし、小規模サイトから業務システムまで対応。' },
      { icon: 'ri:palette-line', title: 'デザインも対応', description: 'UI/UXを考慮した使いやすいデザインを提案します。' },
      { icon: 'ri:smartphone-line', title: 'レスポンシブ対応', description: 'スマホ・タブレットでも快適に使えるサイト・システムを構築。' },
      { icon: 'ri:wrench-line', title: '保守・運用', description: '開発後の保守・機能追加もお任せください。' },
    ],
    flow: [
  ...
  'data-analysis': createServiceData({
    ...
    features: [
      { icon: 'ri:search-line', title: 'データの可視化', description: '複雑なデータをわかりやすいグラフや図表で可視化します。' },
      { icon: 'ri:lightbulb-line', title: 'インサイト抽出', description: 'データから経営に役立つ気づきを見つけ出します。' },
      { icon: 'ri:line-chart-line', title: '予測・シミュレーション', description: '将来予測や施策のシミュレーションを行います。' },
      { icon: 'ri:refresh-line', title: 'レポート自動化', description: '定期レポートの自動作成の仕組みを構築します。' },
    ],
    flow: [
  ...
  'kpi-dashboard': createServiceData({
    ...
    features: [
      { icon: 'ri:flashlight-line', title: 'リアルタイム更新', description: 'データを自動で収集・更新し、常に最新の状況を把握できます。' },
      { icon: 'ri:palette-line', title: '見やすいデザイン', description: '一目で状況がわかる、直感的なダッシュボードを設計します。' },
      { icon: 'ri:links-line', title: '各種データ連携', description: '会計ソフト、SFA、ECなど各種システムからデータを集約。' },
      { icon: 'ri:smartphone-line', title: 'モバイル対応', description: 'スマホやタブレットからもいつでも確認できます。' },
    ],
    flow: [
